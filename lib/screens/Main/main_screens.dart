...
import 'package:wos_official/model/common.dart';
import 'package:wos_official/model/model.dart';
import 'package:wos_official/screens/play/play_screens.dart';
...
class _MainScreenState extends State < MainScreen > {
  ...
  Widget build(BuildContext context) {
    List < CardInfo > musicAlbum = [
      CardInfo('assets/images/album1.png', '', Alignment.bottomRight, 0),
      CardInfo('assets/images/album2.png', '', Alignment.topLeft, 1),
      CardInfo('assets/images/album3.png', '', Alignment.center, 3),
    ];
